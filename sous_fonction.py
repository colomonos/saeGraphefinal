...
G = requet.json_vers_nx("jeux de données réduits-20240521/data_100.txt")
D =requet.recuperer_data("jeux de données réduits-20240521/data_100.txt")
E=requet.bande_acteur(D)
