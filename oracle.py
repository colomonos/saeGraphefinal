...
class Popupcentralite(customtkinter.CTk):
    def __init__(self,distance_centralite):
        ...
        # configure window
        self.title("la distance parcourus")
        ...
        if distance_centralite == 0:
            self.textboxEnsemble.insert("0.0","il est le centre ?")
        else:
...
class distancePOUPUP(customtkinter.CTk):
    def __init__(self,distance_resultat):
        ...
        if distance_resultat == None:
            self.textboxEnsemble.insert("0.0","la distance n'a pas ete trouver")
        else:
...
class Popupestproche(customtkinter.CTk):
    def __init__(self,ensemble_proche):
        ...
        # configure window
        self.title("les acteurs a x distance")
        self.geometry(f"{300}x{300}")
        self.textboxEnsemble = customtkinter.CTkTextbox(self, width=250)
        self.textboxEnsemble.grid(row=0, column=2, padx=(20, 20), pady=(20, 0), sticky="nsew")  
        print(ensemble_proche)
        if ensemble_proche == None:
            self.textboxEnsemble.insert("0.0","la liste est vide vous avez mal taper le nom ou la distance")
            
        else:
            for acteur in ensemble_proche:
                self.textboxEnsemble.insert("0.0","\""+acteur+"\""+"\n")
            self.textboxEnsemble.insert("0.0","les acteurs a x distance")
...
class PopupActeurcommun(customtkinter.CTk):
    def __init__(self,Listecommun):
        ...
        # configure window
        self.title("liste des acteurs commun")
        self.geometry(f"{300}x{300}")
        self.textboxEnsemble = customtkinter.CTkTextbox(self, width=250)
        self.textboxEnsemble.grid(row=0, column=2, padx=(20, 20), pady=(20, 0), sticky="nsew")  
        for acteur in Listecommun:
            self.textboxEnsemble.insert("0.0","\""+str(acteur)+"\""+"\n")   
        self.textboxEnsemble.insert("0.0","liste des acteurs commun"+"\n")      
        self.textboxEnsemble.configure(state="disabled")
...
#___________________________________________________________________________________________________________________________   
        ...
        #ensemblesActeur
        self.sidebar_button_4 = customtkinter.CTkButton(self.sidebar_frame,text="listes des acteurs present", command=self.ensemblesActeur)
...
#___________________________________________________________________________________________________________________________    
        ...
        self.entryA = customtkinter.CTkEntry(self.sidebar_frame2, placeholder_text="entrer un acteur")
...
#___________________________________________________________________________________________________________________________    
        ...
        self.entryB = customtkinter.CTkEntry(self.sidebar_frame3, placeholder_text="entrer un acteur")
...
#___________________________________________________________________________________________________________________________   
        ...
        self.entryC = customtkinter.CTkEntry(self.sidebar_frame4, placeholder_text="entrer une Distance")
...
#___________________________________________________________________________________________________________________________    
    ...
    def collaboproches(self):
        ...
        try:
            ...
            c=0
        ensemble_proche=requet.collaborateurs_proches(sous_fonction.G,a,c)
    ...
    def collaborateurcom(self):
        a=self.entryA.get()
        b=self.entryB.get()
        Ensemble=requet.collaborateurs_communs(sous_fonction.G,a,b)
        print(Ensemble)
    ...
    def distance(self):
        ...
        distanceparcourus=requet.distance(sous_fonction.G,a,b)
    ...
    def Bouton_centralite(self):
        a=self.entryA.get()
        distance_centralite=requet.centralite(sous_fonction.G,a)
